...
//		if (mLat1 instanceof Double
//				&& mLon1 instanceof Double
//				&& mLat2 instanceof Double
//				&& mLon2 instanceof Double && mLat1 != 0 && mLon1 != 0
//				&& mLat2 != 0 && mLon2 != 0) {
...
//	}
	...
	public static class MyPoiSearchListener implements
		...
		public void onGetPoiDetailResult(PoiDetailSearchResult poiDetailSearchResult) {
			...
			LocationBean mLocationBean = new LocationBean();
//			mLocationBean.setLocName(poiDetailSearchResult.getName());
//			mLocationBean.setAddStr(poiDetailSearchResult.getAddress());
//			mLocationBean.setLatitude(poiDetailSearchResult.getLocation().latitude);
//			mLocationBean.setLongitude(poiDetailSearchResult.getLocation().longitude);
//			mLocationBean.setUid(poiDetailSearchResult.getUid());

			List<PoiDetailInfo> infoList = poiDetailSearchResult.getPoiDetailInfoList();
			if (infoList.size() >0) {
				PoiDetailInfo infoResult = infoList.get(0);
				mLocationBean.setLocName(infoResult.getName());
				mLocationBean.setAddStr(infoResult.getAddress());
				mLocationBean.setLatitude(infoResult.getLocation().latitude);
				mLocationBean.setLongitude(infoResult.getLocation().longitude);
				mLocationBean.setUid(infoResult.getUid());
