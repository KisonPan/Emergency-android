...
public class GroupInfoLayout extends LinearLayout implements IGroupMemberLayout, View.OnClickListener {
    ...
    private static final String TAG = com.tencent.qcloud.tim.uikit.modules.group.info.GroupInfoLayout.class.getSimpleName();
    ...
    private void init() {
        inflate(getContext(), com.tencent.qcloud.tim.uikit.R.layout.group_info_layout, this);
        // 标题
        mTitleBar = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_info_title_bar);
        mTitleBar.getRightGroup().setVisibility(GONE);
        mTitleBar.setTitle(getResources().getString(com.tencent.qcloud.tim.uikit.R.string.group_detail), TitleBarLayout.POSITION.MIDDLE);
        ...
        // 成员标题
        mMemberView = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_member_bar);
        mMemberView.setOnClickListener(this);
        mMemberView.setCanNav(true);
        // 成员列表
        GridView memberList = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_members);
        mMemberAdapter = new GroupInfoAdapter();
        memberList.setAdapter(mMemberAdapter);
        // 群类型，只读
        mGroupTypeView = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_type_bar);
        // 群ID，只读
        mGroupIDView = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_account);
        // 群聊名称
        mGroupNameView = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_name);
        mGroupNameView.setOnClickListener(this);
        mGroupNameView.setCanNav(true);
        // 群头像
        mGroupIcon = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_icon);
        mGroupIcon.setOnClickListener(this);
        mGroupIcon.setCanNav(false);
        mGroupIcon.setVisibility(View.GONE);
        // 群公告
        mGroupNotice = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_notice);
        mGroupNotice.setOnClickListener(this);
        mGroupNotice.setCanNav(true);
        // 加群方式
        mJoinTypeView = findViewById(com.tencent.qcloud.tim.uikit.R.id.join_type_bar);
        mJoinTypeView.setOnClickListener(this);
        mJoinTypeView.setCanNav(true);
        mJoinTypes.addAll(Arrays.asList(getResources().getStringArray(com.tencent.qcloud.tim.uikit.R.array.group_join_type)));
        // 群昵称
        mNickView = findViewById(com.tencent.qcloud.tim.uikit.R.id.self_nickname_bar);
        mNickView.setOnClickListener(this);
        mNickView.setCanNav(true);
        // 是否置顶
        mTopSwitchView = findViewById(com.tencent.qcloud.tim.uikit.R.id.chat_to_top_switch);
        ...
        // 退群
        mDissolveBtn = findViewById(com.tencent.qcloud.tim.uikit.R.id.group_dissolve_button);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.group_member_bar) {
            if (mMemberPreviewListener != null) {
                mMemberPreviewListener.forwardListMember(mGroupInfo);
            }
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.group_name) {
            Bundle bundle = new Bundle();
            bundle.putString(TUIKitConstants.Selection.TITLE, getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_group_name));
        ...
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.group_icon) {
        ...
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.group_notice) {
            Bundle bundle = new Bundle();
            bundle.putString(TUIKitConstants.Selection.TITLE, getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_group_notice));
        ...
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.self_nickname_bar) {
            Bundle bundle = new Bundle();
            bundle.putString(TUIKitConstants.Selection.TITLE, getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_nick_name_in_goup));
        ...
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.join_type_bar) {
            if (mGroupTypeView.getContent().equals("聊天室")) {
                ToastUtil.toastLongMessage("加入聊天室为自动审批，暂不支持修改");
                return;
            }
            Bundle bundle = new Bundle();
            bundle.putString(TUIKitConstants.Selection.TITLE, getResources().getString(com.tencent.qcloud.tim.uikit.R.string.group_join_type));
        ...
        } else if (v.getId() == com.tencent.qcloud.tim.uikit.R.id.group_dissolve_button) {
    ...
    private void setGroupInfo(GroupInfo info) {
        ...
        mDissolveBtn.setText(com.tencent.qcloud.tim.uikit.R.string.dissolve);
        if (mGroupInfo.isOwner()) {
            ...
            if (mGroupInfo.getGroupType().equals("Private")) {
                mDissolveBtn.setText(com.tencent.qcloud.tim.uikit.R.string.exit_group);
            }
        } else {
    ...
    public void onGroupInfoModified(Object value, int type) {
        switch (type) {
            case TUIKitConstants.Group.MODIFY_GROUP_NAME:
                ToastUtil.toastLongMessage(getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_group_name_success));
            ...
            case TUIKitConstants.Group.MODIFY_GROUP_NOTICE:
                ...
                ToastUtil.toastLongMessage(getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_group_notice_success));
                break;
            ...
            case TUIKitConstants.Group.MODIFY_MEMBER_NAME:
                ToastUtil.toastLongMessage(getResources().getString(com.tencent.qcloud.tim.uikit.R.string.modify_nickname_success));
